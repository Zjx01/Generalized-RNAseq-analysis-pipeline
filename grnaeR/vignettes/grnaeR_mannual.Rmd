---
title: "grnaeR_mannual"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{grnaeR_mannual}
...
<br> CRS_34v0.txt </br>: the txt file contains the baseline RNAseq raw count data for 9 patients received CART therapy and presented with the MAX_CRS_score rated grade 3 or 4 and those who has no CRS symptom noticed.
The data is owned by Tewari Muneesh LAB.

<br> geneList </br>: geneList data contains the entrez id of genes as names and their respective expression level. 
...
# the package locate 2 layers outsides
setwd('../..')
...
# Implementation of the gene_enrichment_visualization module
